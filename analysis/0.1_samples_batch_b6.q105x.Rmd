...
summary[c(1:19,36)] %>%
  ...
  row_spec(14,color= "white",background = "red") %>%
  row_spec(38,color= "white",background = "red") %>%
  row_spec(77,color= "white",background = "red") %>%
  row_spec(78,color= "white",background = "red") %>%
  row_spec(116,color= "white",background = "red") %>%
  row_spec(122,color= "white",background = "red") %>%
  row_spec(130,color= "white",background = "red") %>%
  row_spec(132,color= "white",background = "red") %>%
...
summary[c(1:3,22:23,25:26,29:30)] %>%
  ...
  row_spec(48 ,color= "white",background = "blue")  %>%
  row_spec(75 ,color= "white",background = "blue")  %>%
  row_spec(77 ,color= "white",background = "blue")  %>%
  row_spec(78 ,color= "white",background = "blue")  %>%
  row_spec(94 ,color= "white",background = "blue")  %>%
  row_spec(119 ,color= "white",background = "blue")  %>%
  row_spec(130 ,color= "white",background = "blue")  #%>%
