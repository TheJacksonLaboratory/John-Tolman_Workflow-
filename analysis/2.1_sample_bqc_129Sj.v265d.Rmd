---
title: "Step 1: Sample QC [129Sj.v265d]"
...
#save into pdf
pdf(file = "output/Percent_missing_genotype_data_129Sj.v265d.pdf", width = 20, height = 20)
...
save(percent_missing,file = "data/percent_missing_id_129Sj.v265d.RData")
...
save(summary.cg,file = "data/summary.cg_129Sj.v265d.RData")
...
project <- read.csv("/Users/corneb/Documents/MyJax/CS/Projects/Simon.John.Tolman/haplo.reconst/2020-11-09/all.samples/all.samples/project_129Sj.v265d.csv", as.is=T)
...
#load("data/pr.RData")
pr<-readRDS("/Users/corneb/Documents/MyJax/CS/Projects/Simon.John.Tolman/haplo.reconst/2020-11-11/129Sj.v265d/all_samples_sorted/Jax.Columbia_John__GigaMUGA_genoprobs_36state_sorted.rds")
#load("data/m.RData")
#load("data/nxo.RData")
...
#str(pr)
save(m, file = "data/m_129Sj.v265d.RData")
save(nxo, file = "data/nxo_129Sj.v265d.RData")

e <- calc_errorlod(gm, pr)
#str(e)
e <- do.call("cbind", e)
save(e, file = "data/e_129Sj.v265d.RData")

#snpg <- predict_snpgeno(gm, m)
#snpg <- do.call("cbind", snpg)
#save(snpg, file = "data/snpg_129Sj.v265d.RData")
...
pdf(file = "output/number_crossover_129Sj.v265d.pdf")
...
iplot(seq_along(errors_ind), errors_ind, indID=lab,
      chartOpts=list(xlab="Mouse", ylab="Percent genotyping errors", ylim=c(0, 8),
                     axispos=list(xtitle=25, ytitle=50, xlabel=5, ylabel=5)))
save(errors_ind, file = "data/errors_ind_129Sj.v265d.RData")
...
#load("data/snpg_129Sj.v265d.RData")
#snpg <- gm$geno
...
#pdf(file = "output/Percent_genotype_errors_obs_vs_predicted_129Sj.v265d.pdf",width = 20, height = 20) 
#par(pty="s")
#err_direct <- rowMeans(snpgn != gobs, na.rm=TRUE)*100
#errors_ind_0 <- rowSums(e > 0)[rownames(gm$covar)]/n_typed(gm)*100
#par(mar=c(4.1,4.1,0.6, 0.6))
...
save(qc_info, bad.sample, file = "data/qc_info_bad_sample_129Sj.v265d.RData")
...
save(gm_samqc, file = "data/gm_samqc_129Sj.v265d.RData")
...
#save(e,g,snpg, file = "data/e_g_snpg_samqc_129Sj.v265d.RData")
save(e,g, file = "data/e_g_snpg_samqc_129Sj.v265d.RData")
