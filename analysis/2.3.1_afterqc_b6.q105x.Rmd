---
title: "Effect Of Data Cleaning [b6.q105x]"
...
## Loading Porject
```{r loading project}
load("data/e_g_snpg_samqc_b6.q105x.RData")
gm <- get(load("data/gm_allqc_b6.q105x.RData"))
...
#save into pdf
pdf(file = "output/Percent_missing_genotype_data_qc_b6.q105x.pdf", width = 20, height = 20)
...
save(percent_missing,
     file = "data/percent_missing_id_qc_b6.q105x.RData")
...
save(summary.cg,
     file = "data/summary.cg_qc_b6.q105x.RData")

pdf(file = "output/Proportion_matching_genotypes_before_removal_of_bad_samples_qc_b6.q105x.pdf", width = 20, height = 20) 
...
#str(pr)
save(m, file = "data/m_qc_b6.q105x.RData")
save(nxo, file = "data/nxo_qc_b6.q105x.RData")

e <- calc_errorlod(gm, pr)
#str(e)
e <- do.call("cbind", e)
save(e, file = "data/e_qc_b6.q105x.RData")
...
pdf(file = "output/number_crossover_qc_b6.q105x.pdf")
...
iplot(seq_along(errors_ind), errors_ind, indID=lab,
      chartOpts=list(xlab="Mouse", ylab="Percent genotyping errors", ylim=c(0, 8),
                     axispos=list(xtitle=25, ytitle=50, xlabel=5, ylabel=5)))
save(errors_ind, file = "data/errors_ind_qc_b6.q105x.RData")
...
save(pmis_mar, file = "data/percent_missing_marker_qc_b6.q105x.RData")
...
pdf(file = "output/Percent_missing_genotype_data_per_marker_qc_b6.q105x.pdf")
par(mar=c(5.1,0.6,0.6, 0.6))
hist(pmis_mar, breaks=seq(0, 100, length=201),
     main="", yaxt="n", ylab="", xlab="Percent missing genotypes")
rug(pmis_mar)
...
pdf(file = "output/genotype_frequency_marker_qc_b6.q105x.pdf")
...
save(gf_mar, file = "data/genotype_freq_marker_qc_b6.q105x.RData")
...
pdf(file = "output/genotype_error_marker_qc_b6.q105x.pdf")
grayplot(pmis_mar, errors_mar,
         xlab="Proportion missing", ylab="Proportion genotyping errors")
dev.off()

save(errors_mar, file = "data/genotype_errors_marker_qc_b6.q105x.RData")
