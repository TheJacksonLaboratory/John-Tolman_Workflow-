---
title: "Step 2: SNP QC [129Sj.v265d]"
...
gm <- get(load("data/gm_samqc_129Sj.v265d.RData"))
...
save(pmis_mar, file = "data/percent_missing_marker_129Sj.v265d.RData")
...
pdf(file = "output/Percent_missing_genotype_data_per_marker_129Sj.v265d.pdf")
par(mar=c(5.1,0.6,0.6, 0.6))
hist(pmis_mar, breaks=seq(0, 100, length=201),
     main="", yaxt="n", ylab="", xlab="Percent missing genotypes")
rug(pmis_mar)
...
pdf(file = "output/genotype_frequency_marker_129Sj.v265d.pdf")
...
save(gf_mar, file = "data/genotype_freq_marker_129Sj.v265d.RData")
...
pdf(file = "output/genotype_error_marker_129Sj.v265d.pdf")
grayplot(pmis_mar, errors_mar,
         xlab="Proportion missing", ylab="Proportion genotyping errors")
dev.off()

save(errors_mar, file = "data/genotype_errors_marker_129Sj.v265d.RData")
...
save(bad_markers, file = "data/bad_markers_all_129Sj.v265d.RData")
...
save(gm_allqc, file = "data/gm_allqc_129Sj.v265d.RData")
