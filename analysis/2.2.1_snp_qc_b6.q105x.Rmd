...
gm <- get(load("data/gm_samqc_b6.q105x.RData"))
...
save(pmis_mar, file = "data/percent_missing_marker_b6.q105x.RData")
...
pdf(file = "output/Percent_missing_genotype_data_per_marker_b6.q105x.pdf")
par(mar=c(5.1,0.6,0.6, 0.6))
hist(pmis_mar, breaks=seq(0, 100, length=201),
     main="", yaxt="n", ylab="", xlab="Percent missing genotypes")
rug(pmis_mar)
...
pdf(file = "output/genotype_frequency_marker_b6.q105x.pdf")
...
save(gf_mar, file = "data/genotype_freq_marker_b6.q105x.RData")
...
pdf(file = "output/genotype_error_marker_b6.q105x.pdf")
grayplot(pmis_mar, errors_mar,
         xlab="Proportion missing", ylab="Proportion genotyping errors")
dev.off()

save(errors_mar, file = "data/genotype_errors_marker_b6.q105x.RData")
...
save(bad_markers, file = "data/bad_markers_all_b6.q105x.RData")
...
save(gm_allqc, file = "data/gm_allqc_b6.q105x.RData")
