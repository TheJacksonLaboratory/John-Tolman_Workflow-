---
title: "Step 1: Sample QC [b6.v265d]"
...
gm <- read_cross2("/Users/corneb/Documents/MyJax/CS/Projects/Simon.John.Tolman/haplo.reconst/2020-11-11/b6.v265d/all_samples_sorted/qtl2/gm_sorted.json")
...
#save into pdf
pdf(file = "output/Percent_missing_genotype_data_b6.v265d.pdf", width = 20, height = 20)
...
save(percent_missing,file = "data/percent_missing_id_b6.v265d.RData")
...
save(summary.cg,file = "data/summary.cg_b6.v265d.RData")
...
#str(pr)
save(m, file = "data/m_b6.v265d.RData")
save(nxo, file = "data/nxo_b6.v265d.RData")

e <- calc_errorlod(gm, pr)
#str(e)
e <- do.call("cbind", e)
save(e, file = "data/e_b6.v265d.RData")
...
pdf(file = "output/number_crossover_b6.v265d.pdf")
...
iplot(seq_along(errors_ind), errors_ind, indID=lab,
      chartOpts=list(xlab="Mouse", ylab="Percent genotyping errors", ylim=c(0, 8),
                     axispos=list(xtitle=25, ytitle=50, xlabel=5, ylabel=5)))
save(errors_ind, file = "data/errors_ind_b6.v265d.RData")
...
save(qc_info, bad.sample, file = "data/qc_info_bad_sample_b6.v265d.RData")
...
save(gm_samqc, file = "data/gm_samqc_b6.v265d.RData")
...
#save(e,g,snpg, file = "data/e_g_snpg_samqc_b6.v265d.RData")
save(e,g, file = "data/e_g_snpg_samqc_b6.v265d.RData")
...
bad$Unique_Sample_ID <- as.character(bad.sample$id)
bad$no_pheno <- ifelse(bad.sample$Max_IOP=='', 'XX', '')
