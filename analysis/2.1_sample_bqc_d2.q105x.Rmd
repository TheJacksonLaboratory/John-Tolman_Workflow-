---
title: "Step 1: Sample QC [d2.q105x]"
...
gm <- read_cross2("/Users/corneb/Documents/MyJax/CS/Projects/Simon.John.Tolman/haplo.reconst/2020-11-11/d2.q105x/all_samples_sorted/qtl2/gm_sorted.json")
...
#save into pdf
pdf(file = "output/Percent_missing_genotype_data_d2.q105x.pdf", width = 20, height = 20)
...
save(percent_missing,file = "data/percent_missing_id_d2.q105x.RData")
...
save(summary.cg,file = "data/summary.cg_d2.q105x.RData")
...
#load("data/pr.RData")
pr<-readRDS("/Users/corneb/Documents/MyJax/CS/Projects/Simon.John.Tolman/haplo.reconst/2020-11-11/d2.q105x/all_samples_sorted/Jax.Columbia_John__GigaMUGA_genoprobs_36state_sorted.rds")
#load("data/m.RData")
#load("data/nxo.RData")
...
#str(pr)
save(m, file = "data/m_d2.q105x.RData")
save(nxo, file = "data/nxo_d2.q105x.RData")

e <- calc_errorlod(gm, pr)
#str(e)
e <- do.call("cbind", e)
save(e, file = "data/e_d2.q105x.RData")

#snpg <- predict_snpgeno(gm, m)
#snpg <- do.call("cbind", snpg)
#save(snpg, file = "data/snpg_d2.q105x.RData")
...
pdf(file = "output/number_crossover_d2.q105x.pdf")
...
pdf(file = "output/Percent_genotype_errors_obs_vs_predicted_d2.q105x.pdf",width = 20, height = 20) 
par(pty="s")
err_direct <- rowMeans(snpgn != gobs, na.rm=TRUE)*100
errors_ind_0 <- rowSums(e > 0)[rownames(gm$covar)]/n_typed(gm)*100
par(mar=c(4.1,4.1,0.6, 0.6))
...
save(qc_info, bad.sample, file = "data/qc_info_bad_sample_d2.q105x.RData")
...
save(gm_samqc, file = "data/gm_samqc_d2.q105x.RData")
...
#save(e,g,snpg, file = "data/e_g_snpg_samqc_d2.q105x.RData")
save(e,g, file = "data/e_g_snpg_samqc_d2.q105x.RData")
